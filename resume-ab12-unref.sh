...
train_bsize=4 #10
test_bsize=4 #4
save_path=drive/MyDrive/StereoNet-Last-DFKI/results/ab12_unref #results # the path of saving checkpoints and log
print_freq=30
...
resumeFile=/sceneflow_model_cf_fact3d_1stages/checkpoints/cf_fact3d_fin_sceneflow-2015-2021_08_17-15_25_25-epoch-100-loss0-1.516-lossesSum-1.516.pth #None #/kitti_model_cf_fact3d_3stages/checkpoints/cf_fact3d_fin_kitti-2015-2020_12_19-16_03_29-epoch-2-loss2-10.031-lossesSum-31.297.pth
####for model=cf_fact3d
model_bn=1
BN_1D_last=1
BN_1D=1

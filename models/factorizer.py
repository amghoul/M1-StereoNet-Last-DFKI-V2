'''
class Stream:
    def __init__(self, kernel, channels_in, channels_out, subspace,subspace_layer, subspace_scale, axis=1):
        self.kernels = []
        self.padding = []
        self.strides = []
        self.filters = []
        ...
        if subspace_layer == "conv1d":
            if axis == 1:
                spatial_kernel = [1, 1, k]
                spatial_kernel2 = [1, k, 1]

...
if __name__ == '__main__':
    ...
    BN_1D_last = 0
    is_filter1_differ=0
    filter1_kernels=[[3,3,1],[3,1,1]]
    fact_kernels=[[3,1,3], [1,3,3],[1,3,1],[1,3,3],[3,3,1],[3,1,1]]
    toProfile="noProfiling"
    prof_list=["noProfiling","timeOnly","memlab","logMem","profilingAll"]
    
    print(torch.cuda.get_device_name(torch.cuda.current_device()))
    device = torch.device('cuda')
    model = StereoNetTime(k=3, r=stages-1,is_filter1_differ=is_filter1_differ,filter1_kernels=filter1_kernels,fact_kernels=fact_kernels,BN_1D=BN_1D,BN_2D=BN_2D,BN_1D_last=BN_1D_last,model_bn=model_bn ).to(device)
    ...
    model = StereoNet(k=3, r=stages-1,is_filter1_differ=is_filter1_differ,filter1_kernels=filter1_kernels,fact_kernels=fact_kernels,BN_1D=BN_1D,BN_2D=BN_2D,BN_1D_last=BN_1D_last,model_bn=model_bn).cuda()
    print(model)
    ...
    model = StereoNetProf(k=3, r=stages-1,is_filter1_differ=is_filter1_differ,filter1_kernels=filter1_kernels,fact_kernels=fact_kernels,BN_1D=BN_1D,BN_2D=BN_2D,BN_1D_last=BN_1D_last,model_bn=model_bn).to(device)

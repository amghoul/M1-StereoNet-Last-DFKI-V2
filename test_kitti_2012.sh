...
datatype=2012 # 2015    2012
model=cf_fact3d # org cf_sepconv  cf_fact3d
mode=test # train   finetune    test
datapath=/home/alghoul/myenv/kitti2012/training # /home/alghoul/myenv/FlyingThings3D    /home/alghoul/myenv/kitti2015/training
flip_vertical=0
epochs=100
lr=0.001
train_bsize=1 #10
...
quantFL=8 #8
####for testing
testFile=/cf_fact3d_fin_kitti-2012-2021_01_30-17_15_18-epoch-3200-loss3-0.148-lossesSum-0.74.pth
#testFile=/cf_fact3d_fin_kitti-2015-2021_01_31-02_59_50-epoch-2800-loss3-0.115-lossesSum-0.616.pth
### for resuming

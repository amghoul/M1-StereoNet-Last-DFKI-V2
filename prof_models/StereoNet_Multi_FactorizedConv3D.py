...
if __name__ == '__main__':
    ...
    for stages in stages_list:
        ...
        print("!!!!!!!! Profiling stage: " , str(stages))
        print_model_info(model_bn,is_filter1_differ,BN_1D_last,modeltype,fact_kernels,BN_1D,BN_2D)
        model = StereoNet(k=3, r=stages-1,is_filter1_differ=is_filter1_differ,filter1_kernels=filter1_kernels,
            fact_kernels=fact_kernels,BN_1D=BN_1D,BN_2D=BN_2D,BN_1D_last=BN_1D_last,model_bn=model_bn).to(device)
        model_time = StereoNetTime(k=3, r=stages-1,is_filter1_differ=is_filter1_differ,filter1_kernels=filter1_kernels,
            fact_kernels=fact_kernels,BN_1D=BN_1D,BN_2D=BN_2D,BN_1D_last=BN_1D_last,model_bn=model_bn ).to(device)
        model_memlab = StereoNetProf(k=3, r=stages-1,is_filter1_differ=is_filter1_differ,filter1_kernels=filter1_kernels,
            fact_kernels=fact_kernels,BN_1D=BN_1D,BN_2D=BN_2D,BN_1D_last=BN_1D_last,model_bn=model_bn).to(device)

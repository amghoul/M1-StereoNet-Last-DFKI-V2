...
train_bsize=4 #10
test_bsize=4 #4
save_path=drive/MyDrive/StereoNet-Last-DFKI/results
print_freq=30
...
quantFL=8 #8
####for testing
testFile=/sceneflow_model_org_4stages/checkpoints/org_fin_sceneflow-2015-2021_08_17-12_01_30-epoch-99-loss3-0.712-lossesSum-3.874.pth
### for resuming

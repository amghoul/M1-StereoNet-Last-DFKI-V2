...
train_bsize=4 #10
test_bsize=4 #4
save_path=drive/MyDrive/StereoNet-Last-DFKI/results/ab12_unref
print_freq=30
...
quantFL=8 #8
####for testing
testFile=/sceneflow_model_cf_fact3d_1stages/checkpoints/best_checkpoints/checkpoint-epoch_348-sumlosses_1.27555.pth
### for resuming

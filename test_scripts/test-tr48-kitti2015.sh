...
train_bsize=8 #10
test_bsize=1 #4
save_path=finetune_results/tr48-ab06
print_freq=100
checkpoint_save_thr=50
abs_thr=3
####load pretrained model
loadmodel=None #/pretrainedModels/best-tr48-epoch_296.pth #None #/pretrainedModels/org_2Stages_finetune_kitti2015-2020_10_19-21_44_15-epoch-1908-loss1-0.52-lossesSum-1.17-EarlyStopping-stereonet.pth
#### quantization
with_quant=0
quantWL=16 #10
quantFL=8 #8
####for testing
testFile=/kitti_2015_model_cf_fact3d_4stages/checkpoints/best_checkpoints #None #/checkpoint_finetune_kitti2015-2020_12_04-21_28_07-epoch-4000-loss1-0.317-lossesSum-4.391.pth
### for resuming
resume=0 # resume path
resumeFile=None #/sceneflow_model_cf_fact3d_4stages/checkpoints/cf_fact3d_fin_sceneflow-2015-2021_04_18-14_37_14-epoch-100-loss3-0.506-lossesSum-3.225.pth
####for model=cf_fact3d
model_bn=1
BN_1D_last=1
BN_1D=1
BN_2D=0
is_filter1_differ=0
filter1_kernels="331 133 311"
fact_kernels="331 133 311"
####

...
train_bsize=8 #10
test_bsize=1 #4
save_path=finetune_results/tr52-ab11
print_freq=100
checkpoint_save_thr=50
abs_thr=3
####load pretrained model
loadmodel=None #/pretrainedModels/best-tr52-ab11--epoch_286.pth #None #/pretrainedModels/org_2Stages_finetune_kitti2015-2020_10_19-21_44_15-epoch-1908-loss1-0.52-lossesSum-1.17-EarlyStopping-stereonet.pth
#### quantization
with_quant=0
quantWL=16 #10
quantFL=8 #8
####for testing
testFile=/kitti_2012_model_cf_fact3d_4stages/checkpoints/best_checkpoints/best-tr52-kitti2012-epoch_3444.pth #None #/checkpoint_finetune_kitti2015-2020_12_04-21_28_07-epoch-4000-loss1-0.317-lossesSum-4.391.pth
### for resuming

...
train_bsize=8 #10
test_bsize=1 #4
save_path=finetune_results/tr25-ab13 #results # the path of saving checkpoints and log
print_freq=100
...
quantFL=8 #8
####for testing
testFile=/kitti_2012_model_cf_fact3d_4stages/checkpoints/best_checkpoints/best-tr25-kitti2012-epoch_3479.pth #None #/checkpoint_finetune_kitti2015-2020_12_04-21_28_07-epoch-4000-loss1-0.317-lossesSum-4.391.pth
### for resuming

...
train_bsize=8 #10
test_bsize=1 #4
save_path=results/train-org-model-from-scratch
print_freq=30
...
quantFL=8 #8
####for testing
testFile=/sceneflow_model_org_4stages/checkpoints/best_checkpoints/best-tr23-org-epoch_363.pth #None #/checkpoint_finetune_kitti2015-2020_12_04-21_28_07-epoch-4000-loss1-0.317-lossesSum-4.391.pth
### for resuming

...
resumeFile=/sceneflow_model_org_4stages/checkpoints/org_fin_sceneflow-2015-2021_08_26-12_51_13-epoch-100-loss3-21.909-lossesSum-81.287.pth #None #/kitti_model_cf_fact3d_3stages/checkpoints/cf_fact3d_fin_kitti-2015-2020_12_19-16_03_29-epoch-2-loss2-10.031-lossesSum-31.297.pth
####for model=cf_fact3d
model_bn=1
BN_1D_last=1
BN_1D=1
...
####
max_checkpoints_to_save=10
threshold_overfit_epochs=20

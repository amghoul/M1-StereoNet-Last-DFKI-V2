...
train_bsize=8 #10
test_bsize=8 #4
save_path=results #results # the path of saving checkpoints and log
print_freq=30
...
resumeFile=/sceneflow_model_cf_fact3d_4stages/checkpoints/best_checkpoints/checkpoint-epoch_193-sumlosses_4.76882.pth
####for model=cf_fact3d
model_bn=1
BN_1D_last=1
BN_1D=1
